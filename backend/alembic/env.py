"""Alembic environment configuration for LexIndia migrations.

Reads the database URL from app.config.settings and uses the ORM Base metadata
for autogeneration support. Handles both offline (SQL script) and online (DB connection) modes.
"""
